  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../views/stock/zhh-work')
      }, {
        path: 'stockControl',
        name: "stockControl",
        meta: {
        ...
        component: () => import('../views/stock/stockControl/views/zhh-stockControl')
      }, {
        path: 'exWarehouse',
        name: "exWarehouse",
        meta: {
        ...
        component: () => import('../views/stock/exWarehouse/views/zhh-exWarehouse')
      }, {
        path: 'warehousing',
        name: "warehousing",
        meta: {
        ...
        component: () => import('../views/stock/warehousing/views/zhh-warehousing')
      }, {
        path: 'allocation',
        name: "allocation",
        meta: {
        ...
        component: () => import('../views/stock/allocation/views/zhh-allocation')
      }, {
        path: 'install',
        name: "install",
        meta: {
        ...
        component: () => import('../views/stock/install/views/zhh-install')
      },
    ]
  }
]
