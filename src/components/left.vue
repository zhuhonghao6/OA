...
export default {
  ...
  methods: {
    ...
    yan(item) {
      ...
      if (this.i == "仓库") {
        this.res = [
          { label: "工作台", pageUrl: "/homepage/works" },
          { label: "库存管理", pageUrl: "/homepage/stockControl" },
          { label: "入库管理", pageUrl: "/homepage/exWarehouse" },
          { label: "出库管理", pageUrl: "/homepage/warehousing" },
          { label: "调拨管理", pageUrl: "/homepage/allocation" },
          { label: "设置", pageUrl: "/homepage/install" },
        ];
        this.$router.push("/homepage/works");
      }
      // if (this.i == "通讯录") {
  ...
  created() {
    ...
    const dat = [
      ...
      { id: "11", name: "工资", icon: "icon-gongzi" },
      { id: "12", name: "仓库", icon: "icon-cangkuguanli" },
    ];
    // 预添加
