...
export default {
  data() {
    return {
      ...
      form2: { wageHandove: "", companHandove: "", desc: "" },
      show: false,
      show2: false,
      show3: false,
      // 头像
  ...
  created() {
    ...
    gets("Active/getActiveById", {
      ...
      this.form.name = res.data.lizhiren.name;
      if (res.data.jiaojieren) {
        console.log(res.data.jiaojieren);
        this.form.name2 = res.data.jiaojieren.name;
      }
      this.form.time1 = res.data.activeDate;
      this.form.submitSector = res.data.submitSector;
      this.form.posts = res.data.lizhiren.posts;
      this.form.active = res.data.activeReasons;
      this.form2.wageHandove = res.data.wageHandove;
      this.form2.companHandove = res.data.companyHandove;
      ...
      console.log(this.approvalComments, 8989);
      // 审批状态
  ...
  methods: {
    ...
    tij() {
      ...
      postp("Active/updateActive", this.wenjian)
        .then((res) => {
          console.log(res);
          // 按钮
          setTimeout(() => {
