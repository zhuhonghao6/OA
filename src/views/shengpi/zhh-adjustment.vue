      ...
      <el-form class="form" :model="form2" label-width="120px">
        ...
        <el-col :span="7">
          <el-form-item label="申请岗位 ：">
            <el-input v-model="form2.postPosition" :disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="10">
          <el-form-item label="申请人数 ：">
            <el-input
              v-model="form2.applicantsNum"
              :disabled="true"
            ></el-input> </el-form-item
        ></el-col>
        ...
        <el-col :span="7">
          <el-form-item label="原有空缺名额 ：">{{ jobNum }} </el-form-item>
        </el-col>
      </el-form>
      <el-form class="form" :model="form" label-width="120px">
        <el-col :span="24">
...
export default {
  ...
  created() {
    ...
    gets("PostsAssignment/getPostsAssignmentById", {
      ...
      this.form.descs = res.data.reason;
      // console.log(res.data.approvalDuration,2222)
      this.location = res.data.location;
      this.form2.postPositionOld = res.data.bpostsName;
      this.form2.postPosition = res.data.jobName;
      this.form2.applicantsNum = res.data.postsSum;
      // 表单
      this.froms.sector = res.data.sector;
      this.froms.postsId = res.data.postsId;
      this.froms.jobId = res.data.jobId;
      this.froms.postsSum = res.data.postsSum;
      ...
      // 岗位
      gets("sector/getSectorByid", { id: res.data.sectorId }).then((res) => {
  ...
  methods: {
    // 数据
    shuj() {
      console.log(this.wenjian.id);
      this.wenjian.id = this.froms.id;
      this.wenjian.sector = this.froms.sector;
      this.wenjian.postsId = this.froms.postsId;
      this.wenjian.jobId = this.froms.jobId;
      this.wenjian.postsSum = this.froms.postsSum;
    ...
    tij() {
      ...
      this.shuj();
      postp("PostsAssignment/updatePostsAssignment", this.wenjian)
        .then((res) => {
          console.log(res);
          // 按钮
          setTimeout(() => {
