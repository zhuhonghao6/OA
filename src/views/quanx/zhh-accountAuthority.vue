      ...
      >
        ...
        <div>
          ...
          <el-form :model="form" class="fom">
            ...
            <!-- 是否仓库管理员-->
            <el-form-item label="是否仓库管理员" :label-width="formLabelWidth">
              <el-radio v-model="form.storehouse" label="0">是</el-radio>
              <el-radio v-model="form.storehouse" label="1">否</el-radio>
            </el-form-item>
            <!-- 仓库管理员数据-->
            <el-form-item label="仓库数据-" :label-width="formLabelWidth">
              <el-radio v-model="form.storehouseDataRight" label="0"
                >本仓库</el-radio
              >
              <el-radio v-model="form.storehouseDataRight" label="1"
                >全部</el-radio
              >
            </el-form-item>
            <!-- 审批人说明-->
...
export default {
  ...
  methods: {
    ...
    seet(row) {
      ...
      this.form.storehouse = JSON.stringify(row.storehouse);
      this.form.storehouseDataRight = JSON.stringify(row.storehouseDataRight);
    ...
    xins() {
      ...
      this.form.radio3 = "1";
      this.form.radio3 = "1";
      this.form.storehouse = "1";
      this.form.storehouseDataRight = "1";
      this.form.tiao = "";
    ...
    gets() {
      ...
      var news = {
        ...
        storehouse: this.form.storehouse,
        storehouseDataRight: this.form.storehouseDataRight,
